 ...
 * Reads NEXT_PUBLIC_SUPABASE_URL / SUPABASE_SECRET_KEY from the
...
if (!SUPABASE_URL || !SERVICE_KEY) {
  console.error('Missing NEXT_PUBLIC_SUPABASE_URL / SUPABASE_SECRET_KEY (checked env and apps/web/.env.local).')
  process.exit(1)
}
