...
const PHASE_OPENERS: Record<LunarPhase['id'], (illum: number) => string> = {
  ...
  waxing_gibbous: (illum) =>
    `Растяща луна, ${illum}% осветена. Финалните щрихи преди пълнолунието са в твои ръце.`,
  full: () =>
    'Пълнолуние. Енергията достига връх — празнувай постигнатото и освободи онова, което вече не ти служи.',
  waning_gibbous: (illum) =>
    `Намаляваща луна, ${illum}% осветена. Време за дълбок размисъл върху научените уроци и тих преход назад към себе си.`,
  last_quarter: () =>
    'Последна четвърт. Време за прошка и освобождаване — приключи онова, което вече не върви, и направи място за новото.',
  waning_crescent: () =>
...
const ELEMENT_PHASE_TAIL: Record<Element, Record<LunarPhase['id'], string>> = {
  fire: {
    new:             'Огънят в теб обича празни листи. Пиши дръзко и тръгни.',
  ...
  earth: {
    new:             'Земният знак обича планове. Превърни мечтата в списък.',
    waxing_crescent: 'Строй основата. Твоята природа вече знае как.',
    first_quarter:   'Решенията ти стабилизират цикъла. Вярвай на търпението си.',
    waxing_gibbous:  'Полирай детайлите — ти си майстор в това.',
  ...
  air: {
    ...
    waxing_crescent: 'Разговор или съобщение ще отключи следващата стъпка. Задай въпроса.',
    ...
    waning_gibbous:  'Обобщи наученото. Думите запечатват урока.',
    last_quarter:    'Прекъсни мислите, които те въртят в кръг. Смени посоката.',
    waning_crescent: 'Дай на ума си пауза — спри анализа.',
  },
  water: {
    ...
    last_quarter:    'Изцели старите рани. Водата знае как да се обнови.',
