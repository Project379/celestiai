...
**Status: DRAFT, awaiting founder ratification.** Converts the thirteen approved screen designs (`.planning/design/` artifacts, see `WARM_COOL_AMENDMENT.md` and `BUILD_VERIFICATION_GUARDS.md`) into a phased engineering plan. Nothing in this document has been built. Halt for ratification of the sequence before Phase 0 fires.
