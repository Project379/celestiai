# Competitor Field Guide: Deep Dive Edition

**Objective:** To dissect the market leaders with the precision of a product surgeon.
**Role:** Critical Product Designer & User Researcher.

---

## 1. Co-Star (The "Cool Kid")
**Core Vibe:** Minimalist, brutalist, "edgy."
**The Hook:** "Astrology for people who don't do astrology."

### 🕵️‍♂️ Mission 1: The Trust Protocol (Onboarding)
1.  **Account Creation:** Note the simple phone number/Apple ID signup.
2.  **The "NASA" Moment:**
...
### ⚠️ Mission 2: The Notification "Hall of Fame"
Co-Star is famous for its unhinged notifications. Look for (or Google) these examples to understand their tone:
*   *"Start a cult."*
...
## 2. The Pattern (The "Therapist")
**Core Vibe:** Deep, psychological, jargon-free.
**The Hook:** "It doesn't feel like astrology; it feels like therapy."

### 🕵️‍♂️ Mission 1: The No-Jargon Challenge
*   *Action:* Read a daily update.
*   *Identify:* Try to find the words "Saturn," "Retrograde," or "House." (You won't).
*   *Translation Guide:*
...
2.  **The Labels:** Look for the specific "Bond Type" tags:
    *   *Positive:* "Soulmate," "Legendary," "Powerful."
    *   *Negative:* "Challenging," "Complex," "Delicate."
3.  **The Detail:** Scroll through the text. It is DENSE.
    *   *Takeaway:* Users *will* read 500 words if it's about *them*. Don't fear long-form AI content if it's high quality.

---

## 3. Hint (The "Salesman")
**Core Vibe:** Commercial, funnel-optimized.
**The Hook:** "We know your secrets (pay us to see them)."

### 🕵️‍♂️ Mission 1: The "Micro-Commitment" Funnel
...
*   *The Trap:* Auto-enrolls into a $30/mo subscription if you forget.
*   *The Upsell:* Watch out for "Soulmate Sketches" or "Palm Readings" sold as extras.

---

## 4. Nebula (The "Marketplace")
**Core Vibe:** The "Kitchen Sink" of Spirituality.

### 🕵️‍♂️ Mission: Feature Overload
...
## 5. The Local Baseline (Bulgaria)
**Target:** *Хороскоп БГ* (or similar)

### 🕵️‍♂️ Mission: The Time Travel
*   *Action:* Open a local Bulgarian app.
*   *Observe:*
