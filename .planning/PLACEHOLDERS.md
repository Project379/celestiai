...
55 OPEN rows + 18 RESOLVED rows = 73 total, per `check-placeholders`'s own
...
deliberately not rewritten; see the row and the reconciled SECRET-SCAN row). BULGARIAN-SKILL-UPDATE added 2026-09-06 (pre-launch
