...
| LINT-BASELINE-1800 | Ratchet has moved 1778→1800→1784→1785/1703 (diverged on two branches, 2026-09-01 through 2026-09-05)→1704 (reconciled on merge to main)→1700 (2026-09-08 quota free-arm cleanup)→1711 (2026-09-09, +11 for the PUSH-ORPHAN mobile settings toggle); each move logged with justification in the script header. ID keeps its "-1800" suffix as a stable handle; current value 1711 | CODE | CC | — | OPEN | | scripts/i18n/check-bg-lint-baseline.mjs |
