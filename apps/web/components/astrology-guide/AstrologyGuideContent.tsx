    ...
    <div className="relative mx-auto max-w-3xl">
      ...
      >
        ...
        <h1 className="font-display flex flex-wrap items-baseline gap-x-3 text-[2.125rem] leading-[1.1] tracking-tight sm:text-[2.75rem]">
          <span className="font-light italic text-slate-400">Какво е</span>
        ...
        <p className="mt-6 max-w-xl font-display text-[17px] font-light italic leading-[1.85] text-slate-400 sm:text-[18px]">
        ...
        <div className="mt-10 grid max-w-2xl gap-x-10 gap-y-7 sm:grid-cols-3">
          {[
            ...
            <div key={item.label}>
              ...
              <p className="mt-2 text-sm italic leading-relaxed text-slate-400/85">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      <Section index={3}>
        ...
        <p className="mb-10 max-w-2xl text-[16px] italic leading-[1.85] text-slate-400">
                ...
                {group.planets.map((planet) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <dd className="text-[13.5px] italic leading-relaxed text-slate-400/85">
                        {planet.desc}
                      </dd>
                    </div>
                  </div>
        ...
        <ul className="divide-y divide-white/[0.05] border-y border-white/[0.05]">
          {aspects.map((aspect) => (
            ...
            >
              ...
              <p className="col-span-2 mt-2 text-[14px] italic leading-relaxed text-slate-400/85 sm:col-span-1 sm:mt-0 sm:text-[14.5px]">
                {aspect.desc}
              </p>
            </li>
          ))}
      ...
      <Section index={5}>
        ...
        <div className="grid gap-y-10 sm:grid-cols-2 sm:gap-x-12 sm:divide-x sm:divide-white/[0.06]">
          <div className="sm:pr-6">
            ...
            <p className="mt-3 text-[14.5px] italic leading-[1.8] text-slate-400/90">
              Носят ежедневни и седмични влияния — настроения, комуникация, малки предизвикателства.
            </p>
            <p className="mt-4 font-cinzel text-[9px] font-semibold uppercase tracking-[0.32em] text-slate-500">
              Цикъл · дни — месеци
            </p>
          </div>
      ...
      {/* ── VI · Method ──────────────────────────────────── */}
      <Section index={6}>
        <SectionMark numeral="VI" eyebrow="Метод" title="Как Celestia изчислява твоята карта" />
          ...
          {calculationSteps.map((item) => (
            <li key={item.numeral} className="grid grid-cols-[3rem_1fr] items-baseline gap-x-5 py-5">
              ...
              <div>
                ...
                <p className="mt-1 text-[14.5px] italic leading-[1.8] text-slate-400/90">
                  {item.desc}
                </p>
              </div>
            </li>
