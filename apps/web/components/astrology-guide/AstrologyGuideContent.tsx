            ...
            <dl className="grid gap-x-10 border-t border-white/[0.05] sm:grid-cols-2">
              {[
                ...
                },
                {
                  name: 'Растяща луна',
                  task: 'Усъвършенствай',
                  appearance: 'Повече от половината Луна е осветена, но още не е пълна. Осветената част продължава да расте, покривайки все по-голяма част от повърхността. Наричана още „млада луна", защото наближава пълнолуние.',
                },
                {
                  name: 'Пълнолуние',
                ...
                },
                {
                  ...
                  task: 'Благодарност',
                  appearance: 'Луната започва да намалява и осветлението отслабва от дясната страна. Повече от половината още е видима, но постепенно се смалява. Наричана още „стара луна".',
                },
                {
                ...
                },
                {
                  ...
                  task: 'Почивка',
                  appearance: 'Луната продължава да намалява, оставяйки тънък сребрист полумесец от лявата страна. Последната видима фаза преди следващото новолуние.',
                },
              ].map((phase) => (
                <div
                  key={phase.name}
