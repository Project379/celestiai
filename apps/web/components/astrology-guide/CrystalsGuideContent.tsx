    ...
    <div className="relative mx-auto max-w-5xl px-4 pb-24 pt-12 sm:px-6">
      ...
      >
        ...
        <p className="mt-5 max-w-2xl font-display text-[17px] font-light leading-[1.85] text-slate-400">
          Тридесет камъка, подредени по планета и лунна фаза. Stellaeum отваря прозорец за някой от тях само когато небето е готово — около новолуние, пълнолуние или когато бавна планета мине близо до картата ти. Пропуснеш ли прозореца, възможността се затваря заедно с него.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="mystic-panel grid gap-px overflow-hidden bg-white/[0.03] sm:grid-cols-2 lg:grid-cols-3">
          ...
          <GuideStep
            numeral="IV"
            title="Транзити"
            body="Когато някоя от бавните планети натисне лична планета в картата ти, Stellaeum отваря прозорец за камък, който да събере този натиск. Прозорецът трае около две седмици — колкото да го усетиш и да решиш дали искаш камъка."
          />
          <GuideStep
            numeral="V"
          ...
          <GuideStep
            ...
            body="Ако поискаш истинския минерал, Stellaeum ще те свърже с български магазин — партньорство, което подготвяме. Засега всичко е дигитално и е част от премиум абонамента."
          />
          <GuideStep
            numeral="VIII"
      ...
      >
        ...
        <div className="mystic-panel space-y-5 px-6 py-8 font-display text-[16px] font-light leading-[1.9] text-slate-300/95 sm:px-10">
          ...
          <p>
            Stellaeum не обещава чудеса. Камъните са по-скоро фокусираща леща — начин да превърнеш една абстрактна астрологична конфигурация в нещо, което можеш да стиснеш между пръстите си. Ритуалът е за теб, не за тях.
          </p>
        </div>
      </motion.section>
