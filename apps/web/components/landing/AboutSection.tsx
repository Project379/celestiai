    ...
    <section id="about" className="relative py-24">
      ...
      <div className="container mx-auto max-w-3xl px-4">
        ...
        <div className="mx-auto max-w-2xl space-y-5 text-center font-display text-[16px] leading-[1.85] text-slate-300/90">
          <p>
            Stellaeum AI е твоят личен астрологичен придружител - създаден специално за българи. Комбинираме вековната мъдрост на астрологията с най-новите технологии, за да ти дадем нещо наистина полезно.
          </p>
          <p>
          ...
          <p className="text-slate-400">
            Звездите имат какво да ти кажат за живота, връзките и потенциала ти. С Stellaeum тези прозрения са само на един клик разстояние.
          </p>
        </div>
