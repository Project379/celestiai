          ...
          <div className="grid grid-cols-2 gap-6 border-t border-white/[0.06] pt-4">
            <div>
              ...
              <p className="text-xs text-slate-300/80">
                Асцендент - твоята <span className="text-slate-200/90">персона</span>. Знакът на хоризонта в момента на раждането. Олицетворява твоето Аз, нови начала и начина, по който другите те виждат на пръв поглед.
              </p>
            </div>
            <div>
              <div className="mb-1 flex items-center gap-2">
              ...
              <p className="text-xs text-slate-300/80">
                MC - твоята <span className="text-slate-200/90">цел</span>. Най-високата точка в картата. Показва кариера, призвание, амбиции и важните стъпки към реализация в живота.
              </p>
            </div>
          </div>
        </div>
