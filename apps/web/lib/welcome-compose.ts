...
const ELEMENT_PHASE_TAIL: Record<Element, Record<LunarPhase['id'], string>> = {
  fire: {
    ...
    waning_gibbous:  'Времето да благодариш на тези, които донесоха пламъка заедно с теб.',
  ...
  earth: {
    ...
    waxing_crescent: 'Строи основата. Твоята природа вече знае как.',
    ...
    waning_crescent: 'Коренете. Остави тялото си да си отдъхне напълно.',
  },
  air: {
    ...
    first_quarter:   'Претегли алтернативите веднъж, после действай. Не повтаряй безкрая.',
    ...
    waning_gibbous:  'Обобщи какво научи. Думите вкарват урока в трайна форма.',
  ...
  water: {
    ...
    waxing_crescent: 'Емоцията е гориво. Позволи и́ да движи първата стъпка.',
    ...
    waning_crescent: 'Сънувай. Ваните, чайовете и тишината са твоята медицина.',
  },
}
