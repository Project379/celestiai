...
const PHASE_META: Record<LunarPhaseId, PhaseMeta> = {
  new: {
    ...
    crystal: 'Лабрадорит, подкрепя възстановяване на енергия и духовно обновление.',
  ...
  waxing_crescent: {
    ...
    bestFor: 'Първи стъпки, подхранване на целите, градеж на нови навици.',
    affirmation: 'Вярвам в пътя си и правя стъпки към мечтите си уверено.',
    crystal: 'Цитрин, стимулира мотивация, творчество и привличане на желаното.',
  ...
  first_quarter: {
    ...
    crystal: 'Планински кристал, усилва енергията и изяснява мисленето.',
  ...
  waxing_gibbous: {
    ...
    physicalAppearance:
      'Повече от половината Луна е осветена, но още не е пълна. Осветената част продължава да расте, покривайки все по-голяма част от повърхността. Наричана още "млада луна", защото наближава пълнолуние.',
    ...
    crystal: 'Планински кристал, изяснява мислите и подготвя ума за успех.',
  ...
  full: {
    ...
    crystal: 'Лунен камък с дъгова преливка, усилва интуицията и женската енергия.',
  ...
  waning_gibbous: {
    ...
    physicalAppearance:
      'Луната започва да намалява и осветлението отслабва от дясната страна. Повече от половината още е видима, но тя постепенно се смалява. Наричана още "стара луна".',
    bestFor: 'Размисъл върху уроци, пускане на стари модели, благодарност за научените уроци.',
    affirmation: 'Освобождавам онова, което вече не ми служи, с благодарност и благосклонност.',
    crystal: 'Розов кварц, символизира любов, състрадание и благодарност.',
  ...
  last_quarter: {
    ...
    crystal: 'Аметист, успокоява и подкрепя медитация и духовен растеж.',
  ...
  waning_crescent: {
    ...
    intention: 'Почивка',
    physicalAppearance:
      'Луната продължава да намалява, оставяйки тънък сребрист полумесец от лявата страна. Това е последната видима фаза преди следващото новолуние.',
    ...
    crystal: 'Аметист, подкрепя почивка, сън и духовно възстановяване.',
...
export function getLunarPhase(date: Date = new Date()): LunarPhase {
  ...
  const phaseId = (BOUNDARIES.find(b => phaseDay < b.maxDay) ?? BOUNDARIES[0]).id
