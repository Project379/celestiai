...
export const VARIANT_2_PROMPTS: Partial<Record<LunarPhaseId, ManifestPrompt>> = {
  ...
  first_quarter: {
    heading: 'Три опори',
    lead: 'Половин път е зад теб. Запиши три опори — какво те държи изправен/а, когато светлина и сянка се делят поравно.',
  ...
  waning_crescent: {
    ...
    lead: 'Нощта преди новото. Запиши три завръщания — къде или към кого се прибираш, преди да започне нов цикъл.',
