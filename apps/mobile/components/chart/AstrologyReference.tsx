  ...
  return (
    <View style={{ gap: 16 }}>
      <Text className="text-[14px] leading-[1.7] text-slate-300/85">
        Наталната карта е кръгова диаграма, показваща точното положение на небесните тела в момента на раждането ти. Чете се отвън навътре: зодиакален пояс, астрологически домове, след това планетите, свързани с цветни линии-аспекти. Запознай се с всеки елемент по-долу, за да четеш картата уверено.
      </Text>
      ...
      <View>
        ...
        <Text className="text-[13px] leading-[1.7] text-slate-300/80">
          Всяка планета въплъщава жизнен принцип: Слънце (сила), Луна (емоция), Меркурий (изразяване), Венера (привличане), Марс (действие), Юпитер (разширение), Сатурн (усилие). Техните позиции разкриват характера ти.
        </Text>
      </View>
      ...
      <View>
        ...
        <Text className="mb-3 text-[13px] leading-[1.7] text-slate-300/80">
          Линиите в центъра показват ъглови връзки между планетите — как различни части от характера ти работят в синхрон или напрежение.
        </Text>
        <View style={{ gap: 6 }}>
      ...
      <View className="border-t border-white/[0.06] pt-4 flex-row" style={{ gap: 16 }}>
        <View className="flex-1">
          ...
          <Text className="text-[11.5px] leading-[1.6] text-slate-300/80">
            Асцендент — твоята <Text className="text-slate-200/90">персона</Text>. Знакът на хоризонта в момента на раждането. Олицетворява твоето Аз, нови начала и начина, по който другите те виждат на пръв поглед.
          </Text>
        </View>
        <View className="flex-1">
          <View className="mb-1.5 flex-row items-center" style={{ gap: 8 }}>
          ...
          <Text className="text-[11.5px] leading-[1.6] text-slate-300/80">
            MC — твоята <Text className="text-slate-200/90">цел</Text>. Най-високата точка в картата. Показва кариера, призвание, амбиции и важните стъпки към реализация в живота.
          </Text>
        </View>
      </View>
    </View>
