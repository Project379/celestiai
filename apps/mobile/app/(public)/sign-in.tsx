    ...
    <SafeAreaView edges={['top', 'bottom']} className="flex-1 bg-bg">
      ...
      >
        ...
        >
          ...
          {/* Sign-up navigation link added in commit 1.4b once /sign-up route exists */}
          <Text className="mt-10 text-center text-[12px] leading-[1.6] text-slate-500">
            Нямаш профил? Регистрацията идва в следващото обновление.
          </Text>
        </ScrollView>
      </KeyboardAvoidingView>
    </SafeAreaView>
