...
/**
 * MOBILE-ALPHA-REDESIGN v3 — Карта. v2's specific failure (founder's
 * Step 3 correction #1): the wheel was buried under a tab row, a
 * four-chip row, AND three Big Three pills before it ever appeared. This
 * version puts the wheel first — it IS the answer to "what is this
 * screen for," visible without scrolling past chrome. Everything else
 * (Big Three, the Details/Aspects/Houses breakdown, the Reference/
 * dictionary view) sits below it or behind a tap, per the ratified
 * prose in .planning/research/MOBILE_ALPHA_REDESIGN.md §0.2.
 *
 ...
 *
 * Reachable at /preview/chart (dev-only entry point in (tabs)/you.tsx).
 */
